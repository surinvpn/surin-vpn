...
state=Thailand
locality=Tebet
organization=surin-vpn
organizationalunit=IT
commonname=surin-vpn.tk
email=bazproz.tk@gmail.com
...
cd /usr/bin
wget -q -O menu "$surin/news"
wget -q -O .surin-vpn "$surin/menu_350.sh"
wget -q -O chek "$surin/lock.sh"
wget -q -O m "$surin/menu_350.sh"
wget -q -O speedtest "$surin/speedtest.py"
wget -q -O b-user "$surin/b-user.sh"
