...
exit 0
 ...
 if [[ -e /etc/debian_version ]]; then
 cd
wget -q -O install "$surin/debian7"
bash install
exit
fi
   cd
wget -q -O install "$surin/CentOS7"
bash install
exit
...
cd
wget -q -O install "$surin/debian8"
bash install
exit
...
cd
wget -q -O install "$surin/debian9"
bash install
exit
# Ubuntu 14.04
elif [[ "$VERSION_ID" = 'VERSION_ID="14.04"' ]]; then
cd
wget -q -O install "$surin/ubuntu14.4"
bash install
exit
...
cd
wget -q -O install "$surin/ubuntu16.4"
bash install
exit
fi
echo ""
